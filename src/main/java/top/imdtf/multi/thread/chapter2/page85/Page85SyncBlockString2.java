package top.imdtf.multi.thread.chapter2.page85;
 ...
 */
public class Page85SyncBlockString2 {
    public static void main(String[] args) {
        Service service = new Service();
        ThreadUtil.newThread(service::method, "A").start();
        ThreadUtil.sleep(1);
        ThreadUtil.newThread(service::method2, "B").start();
    }
